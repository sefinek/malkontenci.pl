...
const ARCHETYPES = [
	...
	},
	{
		...
		diagnosis: 'Irytujesz się we właściwych momentach i w rozsądnych dawkach. To zdrowy, kontrolowany malkontentyzm. Potrafisz zauważyć, że coś nie działa, skomentować to jednym westchnieniem i wrócić do swoich zajęć. Reagujesz, ale nie opisujesz całej sytuacji na trzech grupach na Facebooku, nie piszesz reklamacji na cztery strony i nie próbujesz przekonać wszystkich, że świat właśnie się kończy. Nadal dopuszczasz możliwość, że ktoś inny może mieć rację. To dobry wynik, tak trzymaj!',
	...
	},
	{
		...
		treatment: 'Wyrzuć telefon oraz komputer przez okno i zakurw baranka gdziekolwiek. Przez dobę nie kontaktuj się z internetem ani ludźmi posiadającymi własne zdanie. Niestety na tym etapie nasze metody przestają działać. Takie przypadki kierujemy bezpośrednio do placówki partnerskiej w Choroszczy.',
		referral: true,
